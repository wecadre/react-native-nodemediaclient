...
public class NodeCameraViewManager extends ViewGroupManager<RCTNodeCameraView> {
  ...
  @Override
  protected RCTNodeCameraView createViewInstance(
  ...
  public void setAutoPreview(
    RCTNodeCameraView view,
    @Nullable Boolean autoPreview
  ) {
    if (autoPreview == true) {
      view.audioPreview();
    } else {
  ...
  public void setCameraParam(RCTNodeCameraView view, ReadableMap cameraParam) {
    view.setCamera(
      cameraParam.getInt("cameraId"),
      cameraParam.getBoolean("cameraFrontMirror")
    );
  }
  ...
  public void setAudioParam(RCTNodeCameraView view, ReadableMap audioParam) {
    view.setAudio(
      ...
      audioParam.getInt("profile"),
      audioParam.getInt("samplerate")
    );
  }
  ...
  public void setVideoParam(RCTNodeCameraView view, ReadableMap videoParam) {
    view.setVideo(
      videoParam.getInt("preset"),
      videoParam.getInt("fps"),
      videoParam.getInt("bitrate"),
      videoParam.getInt("profile"),
      videoParam.getBoolean("videoFrontMirror")
    );
  }
  ...
  public void setDynamicRateEnable(
    RCTNodeCameraView view,
    boolean dynamicRateEnable
  ) {
  ...
  public Map<String, Integer> getCommandsMap() {
    return MapBuilder.of(
      COMMAND_STARTPREV_NAME,
      COMMAND_STARTPREV_ID,
      COMMAND_STOPPREV_NAME,
      COMMAND_STOPPREV_ID,
      COMMAND_START_NAME,
      COMMAND_START_ID,
      COMMAND_STOP_NAME,
      COMMAND_STOP_ID,
      COMMAND_SWITCH_CAM_NAME,
      COMMAND_SWITCH_CAM_ID,
      COMMAND_SWITCH_FLASH_NAME,
      COMMAND_SWITCH_FLASH_ID,
      // COMMAND_AUDIO_ENABLE_NAME,
      // COMMAND_AUDIO_ENABLE_ID,
      COMMAND_SET_ZOOM_SCALE_NAME,
      COMMAND_SET_ZOOM_SCALE_ID
    );
  }

  @Override
  public void receiveCommand(
    RCTNodeCameraView root,
    int commandId,
